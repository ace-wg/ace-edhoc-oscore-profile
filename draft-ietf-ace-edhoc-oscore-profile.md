...
AUTH\_CRED\_C is specified in the "req_cnf" parameter {{RFC9201}} of the POST request, either transported by value or uniquely referred to. AS could explicity ask C to provide its authentication credential AUTH_CRED_C by value in the Access Token Request, ,e.g. by relying on the method defined in {{I-D.ietf-ace-workflow-and-params}}.
